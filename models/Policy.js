...
const policySchema = new mongoose.Schema({
  ...
  carrierId: { type: mongoose.Schema.Types.ObjectId, ref: 'PolicyCarrier', required: true },
  agentId: { type: mongoose.Schema.Types.ObjectId, ref: 'Agent' },
  collectionId: { type: String, trim: true },
  companyCollectionId: { type: String, trim: true },
  ...
  paymentFrequency: { type: String, enum: ['Monthly', 'Quarterly', 'Semi-Annual', 'Annual'], default: 'Monthly' },
  isActive: { type: Boolean, default: true },
  policyType: { type: String, trim: true },
  policyMode: { type: String, trim: true },
  producer: { type: String, trim: true },
  csr: { type: String, trim: true },
  primaryApplicantId: { type: String, trim: true },
  agencyId: { type: String, trim: true },
  hasActiveClientPolicy: { type: Boolean, default: false }
}, { timestamps: true });
